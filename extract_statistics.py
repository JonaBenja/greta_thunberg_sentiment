...
nl_content = pd.read_csv("nld/nl_greta.tsv", sep="\t", header = 0, keep_default_na=False, encoding = 'utf-8', error_bad_lines=False)
nl_statistics = defaultdict(dict)

# Read in the Italian data and Stanza pipeline
it_nlp = stanza.Pipeline('it')
it_content = pd.read_csv("ita/it_greta.tsv", sep="\t", header = 0, keep_default_na=False, encoding = 'utf-8', error_bad_lines=False)
...
it_statistics['content']['freq_tokens'] = token_frequencies.most_common(20)
it_statistics['content']['freq_token_pos'] = token_pos_frequencies.most_common(20)

token_stopwords = filter_stopwords(token_frequencies, it_stopwords)
it_statistics['content']['freq_token_excl_stopwords'] = token_stopwords.most_common(20)

token_pos_stopwords = filter_stopwords(token_pos_frequencies, it_stopwords)
it_statistics['content']['freq_token_pos_excl_stopwords'] = token_pos_stopwords.most_common(20)

print(token_pos_stopwords.most_common(100))
...
nl_statistics['content']['n-gram_excl_stopwords'] = ngram_stopwords.most_common(20)
...
it_statistics['content']['n-gram_excl_stopwords'] = ngram_stopwords.most_common(20)
